//
//  RouteRawRequestNoResponseWithContext.swift
//  CartExercise
//
...
public struct RouteRawRequestNoResponseWithContext: PRoute {
    ...
    private let handler: (HttpRequest, RequestContext) async throws -> Void
    ...
    public func handle(_ context: RequestContext) async throws -> HttpResponse {
        ...
        try await handler(context.request, context)

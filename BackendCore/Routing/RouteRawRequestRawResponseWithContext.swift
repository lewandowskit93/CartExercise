//
//  RouteRawRequestRawResponseWithContext.swift
//  CartExercise
//
...
public struct RouteRawRequestRawResponseWithContext: PRoute {
    ...
    private let handler: (HttpRequest, RequestContext) async throws -> HttpResponse
    ...
    public func handle(_ context: RequestContext) async throws -> HttpResponse {
        ...
        let rawResponse = try await handler(context.request, context)

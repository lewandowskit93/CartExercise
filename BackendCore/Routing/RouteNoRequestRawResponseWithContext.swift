//
//  RouteNoRequestRawResponseWithContext.swift
//  CartExercise
//
...
public struct RouteNoRequestRawResponseWithContext: PRoute {
    ...
    private let handler: (RequestContext) async throws -> HttpResponse
    ...
    public func handle(_ context: RequestContext) async throws -> HttpResponse {
        ...
        let rawResponse = try await handler(context)

//
//  RouteNoRequestEncodedResponseWithoutContext.swift
//  CartExercise
//
...
public struct RouteNoRequestEncodedResponseWithoutContext<Response: Encodable>: PRoute {
    ...
    private let handler: () async throws -> Response
    ...
    public init(
        ...
        handler: nonisolated(nonsending) @escaping () async throws -> Response)
    {
        self.path = path
        self.method = method

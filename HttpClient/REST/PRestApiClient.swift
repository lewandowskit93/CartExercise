...
public protocol PRestApiClient {
    ...
    func post<RequestPayload: Encodable>(path: String, payload: RequestPayload) async throws -> HttpResponse
    ...
    func put<RequestPayload: Encodable>(path: String, payload: RequestPayload) async throws -> HttpResponse
    ...
    func delete<RequestPayload: Encodable>(path: String, payload: RequestPayload) async throws -> HttpResponse

...
class CartItemView: UIView, PAppStylable {
    ...
    private(set) var quantityStepper: UIStepper!
    private(set) var deleteFromCartButton: UIButton!
    ...
    func applyStyle(style: PAppStyle) {
        ...
        self.deleteFromCartButton.backgroundColor = style.darkBackgroundColor
        self.deleteFromCartButton.tintColor = style.primaryColor
        self.deleteFromCartButton.setImage(UIImage(systemName: "trash"), for: .normal)
    }
    ...
    func configure(with viewModel: CartItemViewModel) {
        ...
        self.quantityStepper.value = viewModel.quantity
        self.quantityStepper.maximumValue = Double(viewModel.offer.availableUnits)
    }
    ...
    private func createViews() {
        ...
        quantityStepper = factories.createStepper()
        self.quantityStepper.minimumValue = 0
        self.quantityStepper.stepValue = 1
        deleteFromCartButton = factories.createButton()
    }
    ...
    private func buildViewHierarchy() {
        ...
        quantityStack.addArrangedSubview(deleteFromCartButton)
    }
    ...
    private func setupConstraints() {
        let constraints: [NSLayoutConstraint] = [
            ...
            deleteFromCartButton.widthAnchor.constraint(equalToConstant: 32),
            deleteFromCartButton.heightAnchor.constraint(equalToConstant: 32)
        ]
